...
public class TitlePanel extends JPanel{
	...
	private void init()
	{
		...
		iconPanel.setBackground(new Color(222,222,222));
		...
		leftlabelpanel.add(bigTitle, new GBC(1,0,1,1).setFill(GBC.BOTH).setInsets(10, 0, 0, 250));
		leftlabelpanel.add(smallTitle, new GBC(1,1,1,1).setFill(GBC.BOTH).setInsets(17, 28, 0, 0));
	}
