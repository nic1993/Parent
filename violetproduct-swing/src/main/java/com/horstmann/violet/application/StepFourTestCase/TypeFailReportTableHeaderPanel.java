...
public class TypeFailReportTableHeaderPanel extends JPanel{
	...
	public TypeFailReportTableHeaderPanel() {
...
//		attributetable.getColumnModel().getColumn(4).setCellRenderer(new MyAllLabelRenderer());
		...
		attributetable.getColumn("测试用例有误").setPreferredWidth(100);
		attributetable.getColumn("测试用例有误").setMinWidth(100);
		
		attributetable.getColumn("程序出现死循环或抛出异常").setPreferredWidth(100);
		attributetable.getColumn("程序出现死循环或抛出异常").setMinWidth(100);
		
		attributetable.getColumn("失败测试用例总数").setPreferredWidth(100);
		attributetable.getColumn("失败测试用例总数").setMinWidth(100);
