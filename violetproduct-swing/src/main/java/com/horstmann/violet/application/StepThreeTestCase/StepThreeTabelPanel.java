...
public class StepThreeTabelPanel extends JPanel {
	...
	public StepThreeTabelPanel(List<String> constraintNameString, List<Double> actualPercentsDoubles, List<Double> pros,
	...
	private void numberinit() {
		...
		table.getTableHeader().setFont(new Font("宋体", Font.PLAIN, 18));
		table.setRowHeight(25);
		// DefaultTableCellRenderer HeaderRender = new
