...
public class SD2UppaalMain {
	...
	public static void transEA(String xml) throws Exception 
	{
	    ...
	    Document dom= reader.read(xml);//解析XML获取代表整个文档的dom对象"EASequence.seq.violet.xml"
...
//			    }
	...
	//在最后根据map添加transition
		    ...
		    Write.creatXML(diagramDaraI.name+".xml",templates,template_names);//给我的
		    WriteForXStream.creatXML(diagramDaraI.name+"ForXStream.xml", templates, template_names);//给wqq
	    }//遍历diagram结束
	}//end
