...
public class ScenceTabelPanel extends JPanel implements Cloneable {
	...
	public ScenceTabelPanel(List<String> sceneNameList, List<String> constraintName, List<String> constraintValue,
			MainFrame mainFrame) {
		// TODO Auto-generated constructor stub
	...
	private void init() {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (isDouble((String) table.getValueAt(table.getSelectedRow(), table.getSelectedColumn()))) {
					double data = Double
							.valueOf((String) table.getValueAt(table.getSelectedRow(), table.getSelectedColumn()));
		...
		table.setPreferredScrollableViewportSize(
				new Dimension(table.getWidth(), table.getRowHeight() * table.getRowCount()));
	}
