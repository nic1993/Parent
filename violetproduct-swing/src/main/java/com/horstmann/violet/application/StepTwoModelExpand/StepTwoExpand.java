...
public class StepTwoExpand extends JPanel{
	...
	public void init()
	{
		...
		estimateLabel = new JLabel("Ä£ÐÍ¼ìÑé");
		exchangeLabel = new JLabel("MarkovÁ´×ª»»");
...
//					if(!isSameName)
//					{
					mainFrame.getStepTwoEvaluateOperation().getTopLabel().setText("µ±Ç°Ä£ÐÍÎª:"+mainFrame.getStepTwoEvaluateOperation().getModel_Name());
//					}
...
//	    	        if(!isSameName)
//					{
	    	        mainFrame.getStepTwoExchangeOperation().getToplabel().setText("µ±Ç°Ä£ÐÍÎª:"+mainFrame.getStepTwoExchangeOperation().getModel_Name());
//					}
