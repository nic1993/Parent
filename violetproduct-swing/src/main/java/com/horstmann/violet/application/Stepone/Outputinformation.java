...
public class Outputinformation extends JPanel{
     ...
     public void init()
     {
    	 ...
    	 panel.add(gapPanel, new GBC(2, 0).setFill(GBC.BOTH).setWeight(1, 0));
    	 panel.add(reducePanel, new GBC(3, 0).setFill(GBC.NONE).setWeight(0, 0).setInsets(5,15,5,15));
    	 panel.add(enlargePanel, new GBC(4, 0).setFill(GBC.NONE).setWeight(0, 0).setInsets(5,0,5,15));
