...
public class NoTimeMarkovFileRadion extends JPanel{
	...
	public NoTimeMarkovFileRadion(MainFrame mainFrame)
	{
		this.mainFrame = mainFrame;
		this.MarkovRoute = mainFrame.getBathRoute() + "/NoTimeMarkov/";
		initFile();
	}
    	...
    	for(JRadioButton radioButton : radioList)
    	{
    		radioButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					mainFrame.getNoTimeCaseOperation().setModelName(getSelectName());
					mainFrame.getNoTimeCaseOperation1().setModelName(getSelectName());
