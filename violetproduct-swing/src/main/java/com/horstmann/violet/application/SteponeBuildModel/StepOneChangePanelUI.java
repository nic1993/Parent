...
public class StepOneChangePanelUI extends PanelUI{
       
       public StepOneChangePanelUI(StepOneButton panel,MainFrame mainFrame)
       {
    	   this.panel = panel;
...
//    	c.setLayout(new GridBagLayout());
    	...
    	addElementToTaskPane(this.mainFrame.getsequencetree(), "顺序图模型                        ", 1);
    	addElementToTaskPane(this.panel.getUseCaseJtree(), "用例图模型                     ", 2);
