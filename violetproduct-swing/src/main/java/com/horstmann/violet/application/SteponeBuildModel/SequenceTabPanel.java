...
public class SequenceTabPanel extends JPanel{
	...
	public SequenceTabPanel(MainFrame mainFrame,String title,int pos) {
	...
	private void panelListene()
	{
		panel.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				// TODO Auto-generated method stub
				mainFrame.getStepOneCenterSequenceTabbedPane().setSelectedIndex(pos);
				panel.setBackground(Color.white);
				int count = mainFrame.getListSequenceTabPanel().size();
				deletelabel.setIcon(beforeCloseIcon);
				for(int i = 0;i < count;i++)
				{
					if(i!= pos)
					{
						mainFrame.getListSequenceTabPanel().get(i).getPanel().setBackground(new Color(240,240,240));
