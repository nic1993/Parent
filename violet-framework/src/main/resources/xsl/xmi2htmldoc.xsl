...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="UML:Class">
		...
		<newFile>
			<xsl:attribute name="path">Class_<xsl:value-of
				select="@name" />.html</xsl:attribute>
			<xsl:attribute name="name">Class_<xsl:value-of
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
				...
				<table class="summary">
					<tr class="TableRowHeading">
						<td colspan="2">Attribute Summary</td>
					</tr>
						...
						<tr class="TableRow">
							...
							<td class="TableCol2">
								...
								<xsl:for-each select=".//UML:Parameter">
									<xsl:value-of
										select="substring-before(.//UML:DataType/@xmi.idref,'-')" />
									<xsl:text> </xsl:text>
									<xsl:value-of select="@name" />
				...
				<table class="summary">
					<tr class="TableRowHeading">
						<td colspan="2">Generalization Summary</td>
					</tr>
					<xsl:for-each select=".//UML:Generalization">
						<tr class="TableRow">
							<td class="TableCol1" colspan="2">
								...
								<a>
									<xsl:attribute name="href">Generalization<xsl:value-of
										select="$name" />.html</xsl:attribute>
				...
				<table class="summary">
					<tr class="TableRowHeading">
						<td colspan="2">Abstraction Summary</td>
					</tr>
					<xsl:for-each select=".//UML:Abstraction">
						<tr class="TableRow">
							<td class="TableCol1" colspan="2">
								...
								<a>
									<xsl:attribute name="href">Abstraction<xsl:value-of
										select="$name" />.html</xsl:attribute>
									<xsl:attribute name="target">description</xsl:attribute>
									<xsl:value-of select="$name" />
								</a>
				...
				<table class="summary">
					<tr class="TableRowHeading">
						<td colspan="2">Association Summary</td>
					</tr>
					<xsl:variable name="id">
						<xsl:value-of select="@xmi.id" />
					</xsl:variable>
					<xsl:for-each select="//UML:Association[.//UML:Class/@xmi.idref=$id]">
						<tr class="TableRow">
							<td class="TableCol1" colspan="2">
								...
								<a>
									<xsl:attribute name="href">Association<xsl:value-of
										select="$name" />.html</xsl:attribute>
									<xsl:attribute name="target">description</xsl:attribute>
									<xsl:value-of select="$name" />
								</a>
				...
				<table class="summary">
					<tr class="TableRowHeading">
						<td colspan="2">Dependency Summary</td>
					</tr>
					<xsl:for-each select=".//UML:Dependency">
						<tr class="TableRow">
							<td class="TableCol1" colspan="2">
								...
								<a>
									<xsl:attribute name="href">Dependency<xsl:value-of
										select="$name" />.html</xsl:attribute>
									<xsl:attribute name="target">description</xsl:attribute>
									<xsl:value-of select="$name" />
								</a>
				...
				<table class="summary">
					<tr class="TableRowHeading">
						<td colspan="2">Attribute Detail</td>
					</tr>
				</table>
				<xsl:for-each select=".//UML:Attribute">
					<h3>
					...
					<xsl:apply-templates
						select=".//UML:Attribute.initialValue/UML:Expression/@*" />
				</xsl:for-each>

				<hr />
				<table class="summary">
					<tr class="TableRowHeading">
						<td colspan="2">Method Detail</td>
					</tr>
				</table>
				<xsl:for-each select=".//UML:Operation">
					<h3>
				...
				<h6>
					Documentation HTML generate by
					<a href="http://alexdp.free.fr/violetumleditor/page.php">Violet</a>
				</h6>
			</html>
		</newFile>
	</xsl:template>
	...
	<xsl:template match="UML:Generalization">
		<newFile>
			...
			<xsl:attribute name="path">Generalization<xsl:value-of
				select="$name" />.html</xsl:attribute>
				...
				<table class="summary">
					...
					<tr class="TableRow">
						<td class="TableCol1" colspan="2">
							...
							<a>
								<xsl:attribute name="href">Class_<xsl:value-of
	...
	<xsl:template match="UML:Abstraction">
		<newFile>
			...
			<xsl:attribute name="path">Abstraction<xsl:value-of
				select="$name" />.html</xsl:attribute>
			<xsl:attribute name="name">index</xsl:attribute>
			<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
				<head>
	...
	<xsl:template match="UML:Dependency">
		<newFile>
			...
			<xsl:attribute name="path">Dependency<xsl:value-of
				select="$name" />.html</xsl:attribute>
			<xsl:attribute name="name">index</xsl:attribute>
			<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
				<head>
	...
	<xsl:template match="UML:Association">
		<newFile>
			...
			<xsl:attribute name="path">Association<xsl:value-of
				select="$name" />.html</xsl:attribute>
			<xsl:attribute name="name">index</xsl:attribute>
			<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
				<head>
				...
				<table class="summary">
					<tr class="TableRowHeading">
						<td colspan="2">Association with</td>
					</tr>
					<xsl:for-each select=".//UML:AssociationEnd">
						<tr class="TableRow">
							<td class="TableCol1">
								<xsl:variable name="idref">
									<xsl:value-of
										select=".//UML:AssociationEnd.participant/UML:Class/@xmi.idref" />
								</xsl:variable>
								<xsl:variable name="class">
									<xsl:value-of select="//UML:Class[@xmi.id=$idref]/@name" />
								</xsl:variable>
	...
	<xsl:template name="index">
		...
		<newFile>
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
				...
				<h1>Summary</h1>
				<br />
				<xsl:text>Documentation HTML generate by </xsl:text>
				<a href="http://alexdp.free.fr/violetumleditor/page.php">Violet</a>
				<table class="summary">
					<tr class="TableRow">
						<td class="TableCol1">Name</td>
						<td class="TableCol2">...</td>
					</tr>
					<tr class="TableRow">
						<td class="TableCol1">Version</td>
						<td class="TableCol2">...</td>
					</tr>
				</table>
				<h6>
			...
			<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
				...
				<body>
					...
					<dl id="menu">
						...
						<xsl:if
							test="not(count(//UML:Class[@name][count(.//UML:Stereotype)=0])=0)">
							<dd id="smenu1">
								<ul>
						...
						<xsl:if
							test="not(count(//UML:Class[@name][count(.//UML:Stereotype)=1])=0)">
							<dd id="smenu2">
								<ul>
	...
	<xsl:template name="getGeneralizationName">
		<xsl:param name="id" />
		<xsl:if
			test="not(string-length(//UML:Generalization[@xmi.id=$id]/@name) = 0)">
		...
		<xsl:if test="string-length(//UML:Generalization[@xmi.id=$id]/@name) = 0">
			<xsl:variable name="idref2">
				<xsl:value-of
					select="//UML:Generalization[@xmi.id=$id]/UML:Generalization.child/UML:Class/@xmi.idref" />
			</xsl:variable>
			<xsl:value-of select="//UML:Class[@xmi.id=$idref2]/@name" />
			<xsl:text>_To_</xsl:text>
			<xsl:variable name="idref">
				<xsl:value-of
					select="//UML:Generalization[@xmi.id=$id]/UML:Generalization.parent/UML:Class/@xmi.idref" />
			</xsl:variable>
			<xsl:value-of select="//UML:Class[@xmi.id=$idref]/@name" />
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="getAbstractionName">
		...
		<xsl:if test="string-length(//UML:Abstraction[@xmi.id=$id]/@name) = 0">
			<xsl:variable name="idref">
				<xsl:value-of
					select="//UML:Abstraction[@xmi.id=$id]/UML:Dependency.client/UML:Class/@xmi.idref" />
			</xsl:variable>
			<xsl:value-of select="//UML:Class[@xmi.id=$idref]/@name" />
			<xsl:text>_To_</xsl:text>
			<xsl:variable name="idref2">
				<xsl:value-of
					select="//UML:Abstraction[@xmi.id=$id]/UML:Dependency.supplier/UML:Class/@xmi.idref" />
			</xsl:variable>
			<xsl:value-of select="//UML:Class[@xmi.id=$idref2]/@name" />
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="getDependencyName">
		...
		<xsl:if test="string-length(//UML:Dependency[@xmi.id=$id]/@name) = 0">
			<xsl:variable name="idref">
				<xsl:value-of
					select="//UML:Dependency[@xmi.id=$id]/UML:Dependency.client/UML:Class/@xmi.idref" />
			</xsl:variable>
			<xsl:value-of select="//UML:Class[@xmi.id=$idref]/@name" />
			<xsl:text>_To_</xsl:text>
			<xsl:variable name="idref2">
				<xsl:value-of
					select="//UML:Dependency[@xmi.id=$id]/UML:Dependency.supplier/UML:Class/@xmi.idref" />
			</xsl:variable>
			<xsl:value-of select="//UML:Class[@xmi.id=$idref2]/@name" />
		</xsl:if>
	</xsl:template>
