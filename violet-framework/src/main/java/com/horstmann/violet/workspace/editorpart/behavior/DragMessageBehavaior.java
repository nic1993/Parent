...
public class DragMessageBehavaior extends AbstractEditorPartBehavior{
	...
	public void onMousePressed(MouseEvent event)
	{
		...
		if(getSelectedEdge().getClass().getSimpleName().equals("TimeEdge"))
		{
...
//			}
	...
	public void onMouseDragged(MouseEvent event)
	{
	    ...
	    Point2D tempStartLocation=selectedEdge.getStartLocation();
	    Point2D tempEndLocation=selectedEdge.getEndLocation();
	    ...
	    if(tempStartLocation.getX()+dx > selectedEdge.getStartEdge().getEndLocation().getX() 
	    		|| tempStartLocation.getX()+dx < selectedEdge.getStartEdge().getStartLocation().getX()){
	    	return;
	    }
	    selectedEdge.setStartLocation(new Point2D.Double(tempStartLocation.getX()+dx,
	    		tempStartLocation.getY()));
	    selectedEdge.setEndLocation(new Point2D.Double(tempEndLocation.getX()+dx,
	    		tempEndLocation.getY()));
